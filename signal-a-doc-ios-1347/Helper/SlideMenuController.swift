...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = UIScreen.main.bounds.width - 80
    public static var leftBezelWidth: CGFloat? = 0
    ...
    public static var rightBezelWidth: CGFloat? = 0
...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        mainContainerView.transform = CGAffineTransform(scaleX: 0.0, y: 0.0)
